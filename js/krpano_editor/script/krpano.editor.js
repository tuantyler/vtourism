...
function save() {
    ...
    $.ajax({
        ...
        url: "http://localhost:2099/server/save",
        data: postData,
...
function autoMove() {
    ...
    krpano.set("hotspot[" + movingSpot.name + "].ath", krpano.get("mouseath"));
    krpano.set("hotspot[" + movingSpot.name + "].atv", krpano.get("mouseatv"));
}
...
function addHotSpot() {
    ...
    krpano.set("hotspot[" + newHotSpotName + "].distorted", false);
